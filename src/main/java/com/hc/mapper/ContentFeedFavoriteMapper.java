...
//@XmlType(propOrder = { "content_feed_id", "category", "title", "image_url", "content_url", "enable","start_date", "end_date" })
public class ContentFeedFavoriteMapper implements Serializable {
  ...
  `end_date` datetime DEFAULT NULL,
	...
	public ContentFeedFavoriteMapper() {

	}

	public ContentFeedFavoriteMapper(Integer contentFeedId, String category,
